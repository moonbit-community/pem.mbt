...
test "private_key_example" {
  ...
  inspect(
    string_starts_with(pem_string, "-----BEGIN RSA PRIVATE KEY-----"),
    content="true",
  )
...
test "certificate_chain_example" {
  ...
  let root_cert = PemBlock::new(
    label="CERTIFICATE",
    data=b"Root CA certificate",
  )
  let intermediate_cert = PemBlock::new(
    label="CERTIFICATE",
    data=b"Intermediate certificate",
  )
...
test "edge_cases_example" {
  ...
  inspect(
    string_starts_with(empty_encoded, "-----BEGIN EMPTY-----"),
    content="true",
  )
  inspect(
    string_ends_with(empty_encoded, "-----END EMPTY-----"),
    content="true",
  )
